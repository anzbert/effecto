//
//  effectoExtensionBufferedAudioBus.hpp
//  effectoExtension
//
...
struct BufferedInputBus : BufferedAudioBus {
     ...
     */
    AUAudioUnitStatus
    pullInput(AudioUnitRenderActionFlags *actionFlags,
        ...
        return pullInputBlock(actionFlags, timestamp, frameCount,
                              inputBusNumber, mutableAudioBufferList);
    }
