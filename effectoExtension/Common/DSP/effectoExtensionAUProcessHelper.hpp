//
//  effectoExtensionAUProcessHelper.hpp
//  effectoExtension
//
...
#include <vector>
#include "effectoExtensionDSPKernel.hpp"
#include "effectoExtensionBufferedAudioBus.hpp"

//MARK:- AUProcessHelper Utility Class
class AUProcessHelper
{
public:
    AUProcessHelper(effectoExtensionDSPKernel& kernel, BufferedInputBus& bufferedInputBus)
    : mKernel{kernel},
...
private:
    effectoExtensionDSPKernel& mKernel;
